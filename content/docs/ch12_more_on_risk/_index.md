...
summarized in the four calculations shown in
Table 12-3.
...
risk. In the next chapter, we shall briely review
study designs and concepts of risk before proceeding to a discussion of how we use estimates of excess
risk to derive causal inferences.

## References | 參考文獻

REFERENCES
1. Mokdad AH, Marks JS, Stroup DF, et al: Actual causes of
death in the United States, 2000. JAMA 291:1238–1245, 2004,
with the correction from JAMA 293:298, 2005.
2. Doll R, Peto R: Mortality in relation to smoking: Twenty
years’ observations on male British doctors. Br Med J
2:1525–1536, 1976.
3. Levin ML: The occurrence of lung cancer in man. Acta Unio
Int Contra Cancrum 9:531, 1953.
4. Leviton A: Deinitions of attributable risk. Am J Epidemiol
98:231, 1973.
Review questions are on the next page.
238
...
found to be 9/1,000 and the incidence among nonsmokers was 1/1,000. From another source we
...
(cases) and without the disease (controls) are compared (Fig. 13-2A). In cohort studies, we compare
the incidence of disease in exposed and in nonexposed individuals, and in case-control studies, we
...
nonexposed groups, we can study only the speciic
...
NOT
EXPOSED
is the situation where we start with a deined population in which the study population is selected on
...
13-4). In a cohort study that starts with a deined
population, it is possible to study multiple exposures. Thus, for example, in the Framingham Study,
it was possible to study many exposures, including
weight, blood pressure, cholesterol level, smoking,
and physical activity among the participating individuals residing in Framingham, Massachusetts.
In cohort studies, incidence in both exposed and
nonexposed groups can be calculated, and we can
therefore directly calculate the relative risk. Prospective cohort studies minimize the potential for
...
signiicant. Cohort studies are desirable when the
exposure of interest is rare. In a case-control design,
we are unlikely to identify a suficient number of
exposed persons when we are dealing with a rare
exposure. In prospective cohort studies in particular we are likely to have better data on the temporal
...
IN A COHORT STUDY
GROUPS COMPARED:
COMPARE INCIDENCE OF DISEASE IN:
EXPOSED
PEOPLE
AND
NON-EXPOSED
...
IN A CASE-CONTROL STUDY
GROUPS COMPARED:
COMPARE THE PROPORTIONS EXPOSED IN:
PEOPLE WITH
THE DISEASE
AND
PEOPLE WITHOUT
...
to carry out because follow-up of a large population over time is required. A greater potential bias
...
a number of advantages. They are relatively inexpensive and require a relatively small number of
subjects for study. They are desirable when the
disease occurrence is rare, because if a cohort study
were performed in such a circumstance, a tremendous number of people would have to be followed
...
encumbered by the dificulties encountered in
...
one of the most dificult methodologic problems
...
The nested case-control design combines elements of both cohort and case-control studies and
offers a number of advantages. The possibility of
recall bias is eliminated because the data on exposure are obtained before the disease develops. Exposure data are more likely to represent the pre-illness
...
Figure 13-3.
only one exposure.
In a cohort study that starts with an exposed group and a nonexposed group, we can study multiple outcomes but
